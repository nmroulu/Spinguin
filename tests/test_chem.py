...
import numpy as np
import itertools
from spinguin.qm.chem import dissociate, associate, permute_spins
from spinguin.qm.basis import make_basis
from spinguin.qm.states import triplet_plus_state, alpha_state
        ...
        for max_spin_order1 in range(1, nspins1+1):
            ...
            for max_spin_order2 in range(1, nspins2+1):
                ...
                for max_spin_order3 in range(2, nspins3+1):
                    ...
                    # Perform association
                    rho3_dense_dense = associate(basis1, basis2, basis3, rho1_dense, rho2_dense, spinmap1, spinmap2)
                    rho3_dense_sparse = associate(basis1, basis2, basis3, rho1_dense, rho2_sparse, spinmap1, spinmap2)
                    rho3_sparse_dense = associate(basis1, basis2, basis3, rho1_sparse, rho2_dense, spinmap1, spinmap2)
                    rho3_sparse_sparse = associate(basis1, basis2, basis3, rho1_sparse, rho2_sparse, spinmap1, spinmap2)

                    # Create the expected state directly
                    rho3_ref = triplet_plus_state(basis3, spins3, 0, 1, sparse=False)
                    ...
                    self.assertTrue(np.allclose(rho3_ref, rho3_sparse_sparse.toarray()))
        ...
        for max_spin_order1 in range(1, nspins1+1):
            ...
            for max_spin_order2 in range(1, nspins2+1):
                ...
                for max_spin_order3 in range(2, nspins3+1):
                    ...
                    rho3_dense = triplet_plus_state(basis3, spins3, 0, 1, sparse=False)
                    rho3_sparse = triplet_plus_state(basis3, spins3, 0, 1, sparse=False)

                    # Perform dissociation
                    rho1_dense, rho2_dense = dissociate(basis1, basis2, basis3, spins1, spins2, rho3_dense, spinmap1, spinmap2)
                    rho1_sparse, rho2_sparse = dissociate(basis1, basis2, basis3, spins1, spins2, rho3_sparse, spinmap1, spinmap2)

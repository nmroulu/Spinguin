...
class SpinSystem:
    ...
    def __init__(self, isotopes: list | tuple | np.ndarray | str) -> None:
        """
        ...
        isotopes : list or tuple or ndarray or str
            ...
            - If ``ArrayLike``: A 1D array containing isotope names as
                strings.
    ...
    def _read_spin_data(
        ...
        name: str,
        file_reader: Callable[..., np.ndarray],
        ...
        raise TypeError(f"{name} should be an array or a string.")
    ...
    def _check_consistency(self) -> None:
        ...
        if self.isotopes.ndim != 1:
            raise ValueError(
                "Isotopes must be a 1D array containing the names of the "
                "isotopes as strings."
            )
        ...
        for isotope in self.isotopes:
            if isotope not in ISOTOPES:
                raise ValueError(
                    f"Isotope '{isotope}' is not defined in the ISOTOPES "
                    "dictionary."
                )
    ...
    def subsystem(self,spins: list[int]) -> Self:
        """
        ...
        ------
        ValueError
            Raised if the selected spin indices are invalid.
        """
    ...
    def chemical_shifts(self) -> np.ndarray:
        ...
        - If ``ArrayLike``: A 1D array containing the chemical shifts in ppm.
    ...
    def chemical_shifts(
        self,
        chemical_shifts: list | tuple | np.ndarray | str,
    ) -> None:
    ...
    def J_couplings(self) -> np.ndarray:
        ...
        - If ``ArrayLike``: A 2D array specifying the scalar
    ...
    def J_couplings(
        self,
        J_couplings: list | tuple | np.ndarray | str,
    ) -> None:
    ...
    def xyz(self) -> np.ndarray | None:
        ...
        - If ``ArrayLike``: A 2D array of size (nspins, 3).
    ...
    @xyz.setter
    def xyz(self, xyz: list | tuple | np.ndarray | str) -> None:
    ...
    @property
    def shielding(self) -> np.ndarray | None:
        """
        ...
        - If ``ArrayLike``: A 3D array of size (nspins, 3, 3) containing the 3x3
    ...
    def shielding(
        self,
        shielding: list | tuple | np.ndarray | str,
    ) -> None:
    ...
    @efg.setter
    def efg(self, efg: list | tuple | np.ndarray | str) -> None:
    ...
    def mults(self) -> np.ndarray:
        ...
        -------
        ndarray
            One-dimensional array of spin multiplicities.
        """
    ...
    def gammas(self) -> np.ndarray:
        ...
        -------
        ndarray
            One-dimensional array of gyromagnetic ratios.
        """
    ...
    def quad(self) -> np.ndarray:
        ...
        -------
        ndarray
            One-dimensional array of quadrupolar moments.
        """

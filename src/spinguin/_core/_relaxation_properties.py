...
class RelaxationProperties:
    ...
    def _validate_relaxation_array(
        self,
        values: np.ndarray,
        name: str,
    ) -> None:
    ...
    def antisymmetric(self, antisymmetric: bool) -> None:
    ...
    def dynamic_frequency_shift(self, dynamic_frequency_shift: bool) -> None:
    ...
    def relative_error(self, relative_error: float) -> None:
    ...
    @property
    def tau_c(self) -> float | np.ndarray | None:
        """
    ...
    def tau_c(
        ...
        # Reject unsupported correlation-time input formats.
            ...
            raise ValueError(
                ...
                "diffusion or three values for anisotropic rotational "
                "diffusion."
            )
    ...
    @property
    def theory(self) -> Literal["redfield", "phenomenological"] | None:
        """
    ...
    @theory.setter
    def theory(self, theory: Literal["redfield", "phenomenological"]) -> None:
    ...
    def thermalization(self, thermalization: bool) -> None:
    ...
    def T1(self) -> np.ndarray | None:
        ...
        - If `ArrayLike`: a one-dimensional array containing
          ``T1`` values for each spin.
    ...
    @molecule.setter
    def molecule(self, molecule: Molecule) -> None:

...
class Parameters:
    ...
    @property
    def magnetic_field(self) -> float | None:
        """
    ...
    def magnetic_field(self, magnetic_field: float | None) -> None:
    ...
    @parallel_dim.setter
    def parallel_dim(self, parallel_dim: int) -> None:
    ...
    def rotating_frame_order(self, rotating_frame_order: int) -> None:
    ...
    def sparse_operator(self, sparse_operator: bool) -> None:
        ...
        status(f"Sparsity setting of operator set to: {self.sparse_operator}\n")
    ...
    def sparse_superoperator(self, sparse_superoperator: bool) -> None:
    ...
    @sparse_state.setter
    def sparse_state(self, sparse_state: bool) -> None:
        ...
        status(f"Sparsity setting of state set to: {self.sparse_state}\n")
    ...
    def propagator_density(self, propagator_density: float) -> None:
    ...
    def zero_hamiltonian(self, zero_hamiltonian: float) -> None:
    ...
    @zero_aux.setter
    def zero_aux(self, zero_aux: float) -> None:
    ...
    def zero_relaxation(self, zero_relaxation: float) -> None:
    ...
    def zero_interaction(self, zero_interaction: float) -> None:
    ...
    def zero_propagator(self, zero_propagator: float) -> None:
    ...
    @zero_pulse.setter
    def zero_pulse(self, zero_pulse: float) -> None:
    ...
    def zero_thermalization(self, zero_thermalization: float) -> None:
    ...
    def zero_equilibrium(self, zero_equilibrium: float) -> None:
    ...
    def zero_time_step(self, zero_time_step: float) -> None:
    ...
    @zero_zte.setter
    def zero_zte(self, zero_zte: float) -> None:
    ...
    @nsteps_zte.setter
    def nsteps_zte(self, nsteps_zte: int) -> None:

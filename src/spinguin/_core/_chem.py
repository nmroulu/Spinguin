...
def _associate_index_map(
    ...
    basis_A_bytes : bytes
        ...
        spherical tensors. Must be converted to bytes for hashing.
    basis_B_bytes : bytes
    ...
    basis_C_bytes : bytes
        ...
        irreducible spherical tensors. Must be converted to bytes for hashing.
    spin_map_A_bytes : bytes
        Indices of spin system A within spin system C. Must be converted to
        bytes for hashing.
    spin_map_B_bytes : bytes
        Indices of spin system B within spin system C. Must be converted to
        bytes for hashing.
...
def _dissociate_index_map(
    ...
    basis_A_bytes : bytes
        Basis set for the subsystem A. It is a 2-dimensional array containing
        sequences of integers describing the Kronecker products of irreducible
        spherical tensors. Must be converted to bytes to use hashing.
    basis_B_bytes : bytes
        Basis set for the subsystem B. It is a 2-dimensional array containing
        sequences of integers describing the Kronecker products of irreducible
        spherical tensors. Must be converted to bytes to use hashing.
    basis_C_bytes : bytes
        Basis set for the composite system C. It is a 2-dimensional array
        containing sequences of integers describing the Kronecker products of
        irreducible spherical tensors. Must be converted to bytes to use
        hashing.
    spin_map_A_bytes : bytes
        Indices of spin system A within spin system C. Must be converted to
        bytes to use hashing.
    spin_map_B_bytes : bytes
        Indices of spin system B within spin system C. Must be converted to
        bytes to use hashing.
...
def dissociate(spin_system_A: SpinSystem,
    ...
    dim_A = spin_system_A.basis.dim
    dim_B = spin_system_B.basis.dim
...
def _permutation_matrix(
    ...
    basis_bytes : bytes
        ...
        tensors. Must be converted to bytes for hashing.
    spin_map_bytes : bytes
        Indices of the spins in the spin system after permutation. Must be
        converted to bytes for hashing.
...
def permutation_matrix(
    ...
    ----------
    spin_system : SpinSystem
        The spin system whose spins are going to be permuted.
    ...
    # Get the permutation matrix and ensure that a separate copy is returned

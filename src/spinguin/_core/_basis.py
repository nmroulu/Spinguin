...
class Basis:
    """
    Manage the basis set associated with a spin system.
    ...
    def __init__(self, spin_system: SpinSystem):
        """
        Initialise the basis handler for a spin system.
    ...
    def truncate_by_coherence(
        ...
        *objs : tuple of {ndarray, csc_array}
        ...
        Returns
        -------
        ndarray or csc_array or tuple or None
